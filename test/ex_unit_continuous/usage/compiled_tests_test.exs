defmodule ExUnitContinuous.CompiledTestsTest do
  ...
  test "compile examples, keep only async test modules" do
    assert [ExUnitContinuous.CompiledASyncTest] == ExUnitContinuous.Updater.compile!(
             "test/ex_unit_continuous/usage/compiled_tests.ex"
           )
  end
...
#  run_in_test(ExUnitContinuous.CompiledASyncTest)
  ...
  # TODO : maybe an extra "test" macro to support the usecase ?
end